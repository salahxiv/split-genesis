...
- QR Code Scanner: `mobile_scanner` Package (bereits in Progress laut feature/qr-code-group-join Branch)
...
- Settlement-Vorschlag: nur innerhalb gleicher Währung (keine Cross-Currency Settlements)
...
Multi-Currency wird oft nachgefragt — pragmatische Lösung ohne Auto-Konvertierung ist der richtige Ansatz für Beta.
